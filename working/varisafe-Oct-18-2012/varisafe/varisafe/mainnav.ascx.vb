...
#End Region
    ...
    Sub writeTopAnchor(ByVal row As DataRow)
        ...
        'Top level link
        If row.Item("pageid") = PageID Or row.Item("pageID") = parentID Then
            'if page is register then direct to registration
            If (row.Item("pagename") = "register") Then
                strNav.Append(vbCrLf & vbTab & "<li class=""active""><a href=""registration.aspx"">")
            Else
        ...
        Else
            If noLineFlag = True Then
                'if page is register then direct to registration
                If (row.Item("pagename") = "register") Then
                    strNav.Append(vbCrLf & vbTab & "<li class=""noline""><a href=""registration.aspx"">")
                Else
            ...
            Else
                'if page is register then direct to registration
                If (row.Item("pagename") = "register") Then
                    strNav.Append(vbCrLf & vbTab & "<li class=""inactive""><a href=""registration.aspx"">")
                Else
