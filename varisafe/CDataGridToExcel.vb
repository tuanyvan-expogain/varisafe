Public Class CDataGridToExcel
    ...
    Public Shared Sub GridViewToExcel(ByVal dgExport As GridView, ByVal response As HttpResponse)
        ...
        'tell the datagrid to render itself to our htmltextwriter
        stringWrite.Write("<html><head><meta http-equiv=""content-type"" content=""text/html; charset=utf-8""></head><body><form id=""Form1"" runat=""server"">")

        dg.RenderControl(htmlWrite)
        stringWrite.Write("</form></body></html>")
