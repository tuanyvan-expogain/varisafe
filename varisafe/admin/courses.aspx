...
<form id="Form1" method="post" runat="server">
    ...
    <asp:textbox id="txtEmail" textmode="multiline" visible="false" runat="server" width="750" height="250" />
    <div class="row">
        <span class="label">Display:</span>
        <asp:dropdownlist id="ddlDisplay" runat="server" autopostback="true">
            <asp:listitem value="-All-">-All-</asp:listitem>
            <asp:listitem value="Upcoming" selected="true">Upcoming</asp:listitem>
            <asp:listitem value="Completed">Completed</asp:listitem>
        </asp:dropdownlist>
    </div>

	    <asp:datagrid id="dgCourses" runat="server" datakeyfield="CourseID" autogeneratecolumns="False"
	        allowsorting="True" ondeletecommand="dgCourses_DeleteCommand">
	        <Columns>
                ...
                <asp:BoundColumn DataField="CourseDate" HeaderText="Date" SortExpression="dte"></asp:BoundColumn>
                ...
                <asp:HyperLinkColumn NavigateUrl="course.aspx" DataNavigateUrlField="CourseID" DataNavigateUrlFormatString="course.aspx?cid={0}" Text="Details" HeaderText="Details"></asp:HyperLinkColumn>
                ...
                <asp:buttoncolumn commandname="Remind" text="Remind" HeaderText="Remind"></asp:buttoncolumn>
                <asp:buttoncolumn commandname="MailList" text="Mail List" headertext="Mail List"></asp:buttoncolumn>
