Public Partial Class register_control
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            ...
            End If
            'Else
            '    Me.Page.FindControl("leftside").Visible = False
        End If

    End Sub

    Protected Sub SetStep(ByVal intStep As Integer)
        ...
        Select Case intStep
            Case 2
                ...
                ltlCourseTypeID.Text = Request.QueryString("cid")
                ...
                With objCourse
                    ...
                    'ddlRegion.Attributes.Add("onchange", "getCities();")
                End With
            Case 3
                dvStep1.Visible = False
                ...
                With objCourse
                    ...
                    If IsNumeric(Request.QueryString("rid")) Then
                        ...
                        'Dim dView As New DataView(.CourseDS.Tables(1), "RegionID = " & Request.QueryString("rid"), "", DataViewRowState.OriginalRows)
                    ...
                    'ddlCity.Attributes.Add("onchange", "getCourses();")
                End With
            Case 4
                dvStep1.Visible = False
                dvStep2.Visible = False
                ...
                With objCourse
                    .City = ddlCity.SelectedValue 'Request.QueryString("cy") 
                    .CourseTypeID = ltlCourseTypeID.Text
